        ...
        <div class="h-screen bg-white">
            <div class="flex">
                <div class="pl-6 bg-gray-200 w-48 h-screen border-r-2 border-gray-400">
                    ...
                    <router-link to="/contacts/create" class="flex items-center py-2 text-xs">
                    ...
                    <router-link to="/contacts" class="flex items-center py-2 text-xs">
                    ...
                    <router-link to="/birthdays" class="flex items-center py-2 text-xs">
                    ...
                    <router-link to="/logout" class="flex items-center py-2 text-xs">
