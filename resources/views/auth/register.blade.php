    ...
    <div class="w-96 bg-blue-900 rounded-lg shadow-xl p-6">
        ...
        <form method="POST" action="{{ route('register') }}" class="pt-8">
                ...
                <div class="relative">
                    ...
                    <div class="col-md-6">
                        <input id="name" type="name" class="pt-8 w-full rounded p-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700" name="name" value="{{ old('name') }}" autocomplete="name" autofocus placeholder="Your Name">
                ...
                <div class="relative pt-3">
                    ...
                    <div class="col-md-6">
                        <input id="password" type="password" class="pt-8 w-full rounded p-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700" name="password" autocomplete="current-password" autofocus placeholder="Password">
                ...
                <div class="relative pt-3">
                    ...
                    <div class="col-md-6">
                        <input id="password-confirm" type="password" class="pt-8 w-full rounded p-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700" name="password_confirmation" autocomplete="current-password-confirm" autofocus placeholder="Confirm">
